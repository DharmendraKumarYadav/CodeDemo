...
export class CategoryComponent implements OnInit {
  formGroup: FormGroup;
  isLoading: boolean;
  formName: string = "Create Category"
  isEdit: boolean = false;
  isAdd: boolean = false;
  isView: boolean = false;
  constructor(@Inject(MAT_DIALOG_DATA) public modalData: ModalData, private spinnerService: SpinnerService, private fb: FormBuilder, public dialogRef: MatDialogRef<CategoryComponent>, private bikeSpecService: BikeSpecificationService, private notificationService: NotificationService) { }
  ...
  save() {
    ...
    this.bikeSpecService.createCategory(formValue).subscribe(
      (response: any) => {
  ...
  update() {
    ...
    this.bikeSpecService.updateCategory(formValue,this.modalData.data.id).subscribe(
      (response: any) => {
        this.notificationService.showSuccess
